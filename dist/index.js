...
var LIFECYCLE_METHODS = ['componentWillMount', 'componentDidMount', 'componentWillReceiveProps', 'shouldComponentUpdate', 'componentWillUpdate', 'componentDidUpdate', 'componentWillUnmount', 'componentDidCatch'];
    ...
    return function (_Component) {
        ...
        function _class() {
            ...
            Object.keys(events).forEach(function (name) {
                ...
                var isLifecycleMethod = LIFECYCLE_METHODS.some(function (methodName) {
                    return methodName === name;
                });
                if (isLifecycleMethod) {
                    _this[name] = handler.bind(_this);
                    return;
                }
        ...
        _createClass(_class, [{
            ...
            value: function render() {
                ...
                var extraData = Object.keys(extras).reduce(function (memo, name) {
                    var extraDataCreator = extras[name];
                    memo[name] = extraDataCreator.call(_this2);
                    return memo;
                }, {});

                return _react2.default.createElement(Template, _extends({}, props, state, _fields, _events, extraData));
            }
        }]);
